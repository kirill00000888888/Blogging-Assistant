...
Для русских запросов используй только русские заголовки: "тон коммуникации" вместо "Tone of voice", "призыв к действию" или "CTA" вместо случайных английских формулировок. Не оставляй строку "Хук:" или "Боли:" пустой перед следующим разделом.`;
